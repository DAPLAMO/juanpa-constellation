...
export function TimeCapsule() {
  ...
  return (
    <div className="absolute inset-0 overflow-y-auto px-6 anim-card">
      {/* Velo oscuro — fixed para que no scrollee con el contenido */}
      <div
      ...
      {/* Contenido — min-h-full + flex para centrar cuando cabe en pantalla */}
      <div className="relative z-10 min-h-full flex items-center justify-center">
        <div className="max-w-xl w-full py-10 sm:py-16">
          {openedIndex === null ? (
            /* Lista de sobres */
            <div key="list">
